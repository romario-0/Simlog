...
const LogTypeDetails = () => {
			...
			<div key={`pattern_field_${idx}`}>
				<div className ="form-group">
						...
						<div className ="form-group">
							...
							{pattern.length > 1 && <button type="button" className = "btn btn-primary" onClick={(e) => removeFields(idx)} >
								Del
							</button>}
			</div>
		));
    ...
    return (
		...
		<div className = "row">
			<div className ="col-lg-10 col-md-5 col-sm-5 container justify-content-center card">
				<h2 className = "text-center"> Create New Log Type </h2>
